 ...
 */
public class JFrameRecordModified extends javax.swing.JFrame {
    ...
    private void jButtonUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonUpdateActionPerformed
       ...
       try {
           ...
           Key selectedKey = (Key) jComboBoxKeyId.getSelectedItem();
           record.setKey(selectedKey);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameRecordModified.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
